...
echo "==> web: shop rail L/R buttons (RTL visual-left)"
npx tsx "$ROOT/packages/web/src/components/shop/shopRailNav.selftest.ts"
...
echo "==> selftest: shop batch 2 SKUs"
npx tsx "$ROOT/packages/api/src/data/shop-batch2-products.selftest.ts"

echo "==> selftest: shop batch 3 SKUs"
npx tsx "$ROOT/packages/api/src/data/shop-batch3-products.selftest.ts"
...
echo "==> selftest: shop batch-multi wave 3 SKUs"
npx tsx "$ROOT/packages/api/src/data/shop-batch-multi-wave3-products.selftest.ts"

echo "==> selftest: shop batch-multi wave 4 SKUs"
npx tsx "$ROOT/packages/api/src/data/shop-batch-multi-wave4-products.selftest.ts"
...
npx tsx "$ROOT/packages/api/src/data/shop-digikala-batch1-part2-products.selftest.ts"
npx tsx "$ROOT/packages/api/src/data/shop-digikala-batch1-part3-products.selftest.ts"
npx tsx "$ROOT/packages/api/src/data/shop-digikala-batch1-part4-products.selftest.ts"

echo "==> selftest: live shop catalog is p221–p341 only"
...
npx tsx "$ROOT/packages/bot/src/handlers/phone-verify-mandatory.selftest.ts"
npx tsx "$ROOT/packages/bot/src/handlers/owner-profile-consult.selftest.ts"
npx tsx "$ROOT/packages/bot/src/handlers/seeker-advice-gender.selftest.ts"
