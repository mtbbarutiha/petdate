 ...
 * Gallery cache-bust is batch-multi-w4-v1 (wave 1–3 stay on their own busts).
...
def write_cache_bust() -> None:
    dest = ROOT / "tmp/cache-bust-shop-batch-multi-w4-v1"
...
def main() -> None:
    ...
    if CACHE_BUST != "batch-multi-w4-v1":
        raise SystemExit("wave 4 cache bust must be batch-multi-w4-v1")
