          ...
          {TEAM.map((m) => (
            <article key={m.slug} className="pepito-member">
              <div className="pepito-member-photo">
                <img src={m.img} alt={t('landing.teamAlt', { name: t(m.nameKey), role: t(m.roleKey) })} loading="lazy" width={400} height={500} decoding="async" />
              </div>
            ...
            <article key={r.handleKey} className="pepito-review">
              <div className="pepito-review-img">
                <div className="pepito-review-img-frame">
                  <img src={r.img} alt={t('landing.reviewAlt', { handle })} loading="lazy" width={400} height={500} decoding="async" />
                </div>
              </div>
