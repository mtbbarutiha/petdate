...
export const FAQ_ITEMS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: 'شماره را با پیش‌شماره صحیح وارد کنید، چند دقیقه صبر کنید و دوباره درخواست کد بدهید. اگر مشکل ادامه داشت از بخش «پشتیبانی» در اپ یا ربات تلگرام پت‌دیت کمک بگیرید (ثبت تیکت یا صحبت با بات پشتیبانی).',
  },
  {
    q: 'دعوت دوستان چه جایزه‌ای دارد؟',
    a: `از ربات یا وب (خانه، کیف پول، پروفایل) لینک دعوت خودت را بگیر و برای دوستات بفرست. لینک سایت petdate.ir/invite است و همان کد ref_ در ربات هم کار می‌کند. با هر ثبت‌نام جدید از لینک تو، ${formatFaInt(REFERRAL_BONUS_COINS)} سکه به موجودی‌ات اضافه می‌شود — فقط یک‌بار برای هر حساب جدید.`,
  },
  {
