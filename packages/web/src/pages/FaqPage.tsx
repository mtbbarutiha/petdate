...
export const FAQ_ITEMS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: 'شماره را با پیش‌شماره صحیح وارد کنید، چند دقیقه صبر کنید و دوباره درخواست کد بدهید. اگر مشکل ادامه داشت از بخش «چت با پشتیبانی» در اپ یا ربات تلگرام پت‌دیت کمک بگیرید.',
  },
  {
