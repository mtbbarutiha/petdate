...
export const SHOP_BATCH3_PRODUCTS: ShopProduct[] = [
  product({
    id: 'p236',
  ...
  product({
    ...
    params: {
      وزن: '۲ کیلوگرم',
      مناسب_برای: 'گربه بالغ سالم با طعم ماهی',
      کشور_برند: 'آلمان',
      نوع_غذا: 'خشک',
    },
    description:
  ...
  product({
    ...
    params: {
      وزن: '۲ کیلوگرم',
      مناسب_برای: 'گربه بالغ با معده حساس',
      کشور_برند: 'آلمان',
      نوع_غذا: 'خشک',
    },
    description:
  ...
  product({
    ...
    params: {
      وزن: '۲ کیلوگرم',
      مناسب_برای: 'مادر باردار/شیرده و بچه گربه تا حدود ۴ ماه',
      کشور_برند: 'فرانسه',
      نوع_غذا: 'خشک',
    },
    description:
  ...
  product({
    ...
    params: {
      وزن: '۱٫۵ کیلوگرم',
      مناسب_برای: 'گربه بالغ مراقبت دهان و دندان',
      کشور_برند: 'فرانسه',
      نوع_غذا: 'خشک',
    },
    description:
  ...
  product({
    ...
    params: {
      وزن: '۱٫۵ کیلوگرم',
      مناسب_برای: 'گربه بالغ مستعد اضافه وزن',
      کشور_برند: 'فرانسه',
      نوع_غذا: 'خشک',
    },
    description:
  ...
  product({
    ...
    params: {
      وزن: '۲ کیلوگرم',
      مناسب_برای: 'گربه بالغ با مشکل گلوله مو',
      کشور_برند: 'فرانسه',
      نوع_غذا: 'خشک',
    },
    description:
  ...
  product({
    ...
    params: {
      وزن: '۲ کیلوگرم',
      مناسب_برای: 'گربه بالغ پوست و مو',
      کشور_برند: 'فرانسه',
      نوع_غذا: 'خشک',
    },
    description:
  ...
  product({
    ...
    params: {
      وزن: '۱٫۵ کیلوگرم',
      مناسب_برای: 'خط دامپزشکی ادراری گربه — تحت نظر کلینیک',
      کشور_برند: 'فرانسه',
      نوع_غذا: 'خشک',
    },
    description:
  ...
  product({
    ...
    params: {
      وزن: '۳ کیلوگرم',
      مناسب_برای: 'سگ بالغ نژاد کوچک عقیم‌شده',
      کشور_برند: 'فرانسه',
      نوع_غذا: 'خشک',
    },
    description:
  ...
  product({
    ...
    params: {
      وزن: '۳ کیلوگرم',
      مناسب_برای: 'سگ بالغ نژاد کوچک مستعد اضافه وزن',
      کشور_برند: 'فرانسه',
      نوع_غذا: 'خشک',
    },
    description:
  ...
  product({
    ...
    params: {
      وزن: '۳ کیلوگرم',
      مناسب_برای: 'پودل بالغ از حدود ۱۰ ماهگی',
      کشور_برند: 'فرانسه',
      نوع_غذا: 'خشک',
    },
    description:
  ...
  product({
    ...
    params: {
      وزن: '۳ کیلوگرم',
      مناسب_برای: 'توله پودل تا حدود ۱۰ ماه',
      کشور_برند: 'فرانسه',
      نوع_غذا: 'خشک',
    },
    description:
  ...
  product({
    ...
    params: {
      وزن: '۲ کیلوگرم',
      مناسب_برای: 'خط دامپزشکی حساسیت غذایی سگ — تحت نظر کلینیک',
      کشور_برند: 'فرانسه',
      نوع_غذا: 'خشک',
    },
    description:
