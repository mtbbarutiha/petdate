...
assert.match(chatPage, /tg-thread-dismiss/, 'thread-header dismiss control');
...
assert.match(vetPage, /tg-thread-dismiss/, 'vet thread-header dismiss control');
assert.match(vetPage, /chat-dismiss-confirm/, 'vet dismiss uses ConfirmModal');
