...
export const SAMPLE_PET_EVENTS: SamplePetEventDef[] = [
  ...
  },
  {
    ...
    joinFee: 35,
    photo: '/events/sample-dating-mashhad.jpg',
    daysAhead: 4,
    hour: 18,
  },
  {
    ...
    services: `کیسه جمع‌آوری، آب خنک · ${SAMPLE_EVENTS_CATALOG_MARKER}`,
    joinFee: 20,
    photo: '/events/sample-walk-bushehr.jpg',
    daysAhead: 6,
    hour: 7,
  },
  {
    ...
    services: `مربی تأییدشده، تشویقی آموزشی · ${SAMPLE_EVENTS_CATALOG_MARKER}`,
    joinFee: 70,
    photo: '/events/sample-training-shiraz.jpg',
    daysAhead: 8,
    hour: 17,
  },
  {
    ...
    joinFee: 45,
    photo: '/events/sample-grooming-tabriz.jpg',
    daysAhead: 9,
    hour: 12,
  },
  {
    ...
    joinFee: 30,
    photo: '/events/sample-dating-karaj.jpg',
    daysAhead: 11,
    hour: 16,
  },
  {
    ...
    joinFee: 15,
    photo: '/events/sample-walk-ahvaz.jpg',
    daysAhead: 12,
    hour: 19,
  },
];
