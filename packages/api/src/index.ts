...
import { shopInvoiceWebRouter } from './routes/shop-invoice-web';
import { paymentsRouter } from './routes/payments';
import { newsletterRouter } from './routes/newsletter';
import { appDownloadSmsRouter } from './routes/app-download-sms';
import { petPurchaseLeadsRouter } from './routes/pet-purchase-leads';
import { supportRouter } from './routes/support';
import { analyticsRouter } from './routes/analytics';
import { magazineRouter } from './routes/magazine';
import { petLoverReviewsRouter } from './routes/pet-lover-reviews';
