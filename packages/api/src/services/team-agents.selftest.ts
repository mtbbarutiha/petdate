...
async function main() {
  ...
  assert.equal(sanazSession, null, 'Sanaz support uses /support/chat not team-agent consult');
  ...
  assert.equal(getTeamAgentByGrokBotKey('yalda-shabani')?.slug, 'sanaz-ghaffari');
