...
assert.equal(parsePositiveIntId('   '), null, 'whitespace');
assert.equal(parsePositiveIntId(undefined), null, 'undefined');
assert.equal(parsePositiveIntId('undefined'), null, 'undefined string');
assert.equal(parsePositiveIntId(null), null, 'null');
assert.equal(parsePositiveIntId('null'), null, 'null string');
