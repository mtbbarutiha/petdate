...
import {
  ...
  DAILY_COIN_REWARD as SHARED_DAILY_COIN_REWARD,
  MIN_SELL_COINS as SHARED_MIN_SELL_COINS,
  REFERRAL_BONUS_COINS as SHARED_REFERRAL_BONUS_COINS,
  WALLET_STARS_TOPUP_PACKS as SHARED_WALLET_STARS_TOPUP_PACKS,
...
export const DAILY_COIN_REWARD = SHARED_DAILY_COIN_REWARD;
export const WALLET_STARS_TOPUP_PACKS = SHARED_WALLET_STARS_TOPUP_PACKS;
