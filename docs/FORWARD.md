...
## ریپوی رسمی پت‌دیت
- **https://github.com/mtbbarutiha/petdat** (تنها منبع رسمی پروژه)
...
2. GitHub Actions → **CI**: https://github.com/mtbbarutiha/petdat/actions
3. GitHub Actions → **Deploy** با `confirm=deploy` و scope=`all`
4. دیپلوی دستی موازی با rsync ناقص ممنوع
